...
var PLAYERS = [
  { name: 'Elby', team: 'Thunder Boys', role: 'Doubles', nickname: 'THE WALL', skill_type: 'Defense', skill_desc: 'Immovable at the net. Blocks and lifts turn into counter-attacks.', theme_primary: '#6a0dad', theme_accent: '#ffd700', stats: { smash_power: 93, defense: 98, agility: 78, strategy: 85, stamina: 88 }, icon: 'shield', profile_photo: player_profile_png('elby'), image: player_profile_png('elby'), placeholder_image: player_placeholder_url('Elby', '6a0dad'), comic_card_art: true },
  { name: 'Amaldev', team: 'Thunder Boys', role: 'Doubles', nickname: 'THE STRATEGIST', skill_type: 'Strategy', skill_desc: 'Reads the game like a chess master. Drops and placement win points.', theme_primary: '#00897b', theme_accent: '#00e5ff', stats: { smash_power: 92, defense: 82, agility: 80, strategy: 97, stamina: 88 }, icon: 'tactics', profile_photo: player_profile_png('amaldev'), image: player_profile_png('amaldev'), placeholder_image: player_placeholder_url('Amaldev', '00897b'), comic_card_art: true },
  { name: 'Amal', team: 'Smart Boys', role: 'Doubles', nickname: 'THE POWERHOUSE', skill_type: 'Power', skill_desc: 'Devastating smashes and explosive jumps. Opponents fear the kill shot.', theme_primary: '#e65100', theme_accent: '#ffeb3b', stats: { smash_power: 98, defense: 85, agility: 82, strategy: 68, stamina: 85 }, icon: 'explosion', profile_photo: player_profile_png('amal'), image: player_profile_png('amal'), placeholder_image: player_placeholder_url('Amal', 'e65100'), comic_card_art: true },
  { name: 'Sanjay', team: 'Smart Boys', role: 'Doubles', nickname: 'THE PLAYMAKER', skill_type: 'Playmaking', skill_desc: 'Sets up partners and creates openings. The court conductor.', theme_primary: '#ff8f00', theme_accent: '#ffd54f', stats: { smash_power: 86, defense: 81, agility: 85, strategy: 92, stamina: 80 }, icon: 'playmaker', profile_photo: player_profile_png('sanjay'), image: player_profile_png('sanjay'), placeholder_image: player_placeholder_url('Sanjay', 'ff8f00'), comic_card_art: true },
  { name: 'Arun', team: 'Smash Masters', role: 'Doubles', nickname: 'THE ENGINE', skill_type: 'Stamina', skill_desc: 'Relentless pace. Outlasts opponents in long rallies.', theme_primary: '#2e7d32', theme_accent: '#69f0ae', stats: { smash_power: 89, defense: 85, agility: 82, stamina: 96, strategy: 74 }, icon: 'gauge', profile_photo: player_profile_png('arun'), image: player_profile_png('arun'), placeholder_image: player_placeholder_url('Arun', '2e7d32'), comic_card_art: true },
  { name: 'Febin', team: 'Smash Masters', role: 'Doubles', nickname: 'THE SPEEDSTER', skill_type: 'Agility', skill_desc: 'Lightning-fast footwork and reflexes. Covers the court in a flash.', theme_primary: '#7cb342', theme_accent: '#ffeb3b', stats: { smash_power: 90, defense: 80, agility: 98, strategy: 72, stamina: 90 }, icon: 'lightning', profile_photo: player_profile_png('febin'), image: player_profile_png('febin'), placeholder_image: player_placeholder_url('Febin', '7cb342'), comic_card_art: true },
];
