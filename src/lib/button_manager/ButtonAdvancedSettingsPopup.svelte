<script>
    ...
    export let button_advanced_settings;
    ...
    onMount(() => {
        console.log('button_info', button_info)
        console.log('button_advanced_settings', button_advanced_settings)

        editable_data = JSON.parse(JSON.stringify(button_advanced_settings || {}));
        editable_items_arr = JSON.parse(JSON.stringify(Button.BUTTON_SETTINGS['default'].customization_config.items));
    ...
    <div bind:this={editorContainer} class="editor-container">
        ...
        <!--{#if form_view}-->
            <EditableFormItemsManager
                    ...
                    sub_module="{button_info.sub_module}"
