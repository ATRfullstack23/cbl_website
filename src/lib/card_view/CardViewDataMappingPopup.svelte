<script>
    ...
    export let card_view_type;
    export let card_view_existing_data_mapping;
    let editorContainer;
    let editor
    ...
    onMount(() => {
        console.log('sub_module', sub_module)
        console.log('card_view_type', card_view_type)
        console.log('card_view_existing_data_mapping', card_view_existing_data_mapping)

        editable_data = JSON.parse(JSON.stringify(card_view_existing_data_mapping || {}));
        editable_items_arr = JSON.parse(JSON.stringify(CardView.TEMPLATES[card_view_type].data_mapping_config.items));
