<script>
    ...
    //employee card configuration ( 4 types )

    FormView.CARD_VIEW_VARIANTS = {
        classic_card: {
            id: "classic_card",
    ...
    //product card configuration ( 2 types )
    ...
    //invoice card configuration ( 2 types )

    FormView.CARD_VIEW_VARIANTS = {
        invoice_card_detailed: {
            id: "invoice_card_detailed",
            display_name: "Invoice Detailed",
            data_mapping_config: {
                items: [
                    {
                        unique_id: "main_header_text",
    ...
    //payment receipt configuration ( 2 types )
    ...
    //financial year card configuration ( 2 types )
    ...
    //leave card configuration ( 3 types )
        ...
        leave_compact_card: {
            ...
            data_mapping_config: {
                items: [
                    ...
                    {
                        unique_id: "contact_info_items",
                        display_name: "Contact info items",
                        data_type: "array_of_objects",
                        input_type: "column_id"
                    },
                    {
    ...
    //customer card configuration ( 3 types )
