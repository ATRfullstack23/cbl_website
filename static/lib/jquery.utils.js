...
;(function ($) {
    //arr: List of Options in {value: "Value", text: "Text" } format.
    //addAll: To add please select
    //addAllText: Text of please select
    $.fn.setSelectOptions = function (arr, addAll, addAllText, ignoreCurrentValue) {
        var element = $(this);
        ...
        if(addAll){
            var option = document.createElement('option');
            if(addAllText != undefined){
                option.innerHTML = addAllText;
            }
            else{
    ...
    $.fn.setNumeric = function (isNumeric, options) {
        ...
        return this.each(function() {
            ...
            if(settings.addClass){
                element.addClass('setNumericElement')
            }
    ...
    $.fn.waitScreen = function (isWaiting, options) {
        ...
        return this.each(function() {
            ...
            if (element.attr('id') == null)
                element.attr('id', 'waitScreen_' + getRandomNumber());
