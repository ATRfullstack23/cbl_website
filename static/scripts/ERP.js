...
///////////////////////////////////////////////////////////////////////////
    ...
    initializeDashboardManager: function(){
        var self = this;
    ...
    removeTopLevelNavigationItem: function(itemIdToRemove){
        var self = this;
    ...
    initializeTopNavigation: function(){
        var self = this;
    ...
    setSelectedTopNavigationMode: function(newMode){
        var self = this;
    ...
    changeModuleNavigationPosition: function(newMode){
        var self = this;
...
//            erp.elements.reportsContainer = self.createReportsContainer(erp).appendTo(document.body);
    ...
    getModulesListAsSelectOptions: function(addAll){
        var self = this;
        var options = [];
        self.forEachModule(function(module){
            var option = document.createElement('option');
